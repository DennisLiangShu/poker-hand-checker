...
public class TestHand {
   public static void main(String[] args) {
      ...
      Hand hand1 = new Hand("5D 9D TD JD 4D");
      Hand hand2 = new Hand("6D 3D 7D 8D AD");
      System.out.println("Poker Hands being compared:");
      System.out.println(hand1.toString());
      System.out.println(hand2.toString());
      int result = hand1.compareTo(hand2);
      if (result == 1) {
         System.out.println("The Winning hand is: " + hand1.toString());
      } else if (result == 0) {
         System.out.println("The Winning hand is: " + hand2.toString());
      } else {
         System.out.println("There was no Winning hand, the pot is split.");
      }

      System.out.println();

      hand1 = new Hand("7S 6S 5S 4S 3S");
      hand2 = new Hand("7D 6D 5D 4D 3D");
      System.out.println("Poker Hands being compared:");
      System.out.println(hand1.toString());
      System.out.println(hand2.toString());
      ...
      hand1 = new Hand("7S 4C 5D 6H 8C");
      hand2 = new Hand("5C 4D 3D 2H AD");
      System.out.println("Poker Hands being compared:");
      System.out.println(hand1.toString());
      System.out.println(hand2.toString());
      result = hand1.compareTo(hand2);
      ...
      hand1 = new Hand("AH AC AS AD KD");
      hand2 = new Hand("5H 5C 5S 5D AD");
      System.out.println("Poker Hands being compared:");
      System.out.println(hand1.toString());
      System.out.println(hand2.toString());
      result = hand1.compareTo(hand2);
      ...
      hand1 = new Hand("2H 2S 2C AH AS");
      hand2 = new Hand("3H 3C 3S 5C 5H");
      System.out.println("Poker Hands being compared:");
      System.out.println(hand1.toString());
      System.out.println(hand2.toString());
      result = hand1.compareTo(hand2);
      ...
      /*int p1wins = 0;
      try {
         for (String line : Files.readAllLines(Paths.get("p054_poker.txt"))) {
            hand1 = new Hand(line.substring(0, 14));
            hand2 = new Hand(line.substring(14, 29).trim());
            result = hand1.compareTo(hand2);
